...
public class CircleArcGenerator : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        GenerateCircleArc(numberOfCubes: 100, radius: centerCircleRadius,angleIncrement: 15f,cubePrefab: startPoint,offset: new Vector3(touchLine/2,0,goalLine/2) );
    }

    void GenerateCircleArc(int numberOfCubes, float radius, float angleIncrement,GameObject cubePrefab, Vector3 offset)
    {
